...
(() => {
    try {
        ...
        if (varVar != undefined) { // varVar is defined nd contains the value defined in the block above.
        ...
        if (letVar != undefined) { // This will throw an error as letVar is not defined so is out of scope.
